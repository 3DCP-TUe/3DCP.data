...
text(0.25, 0.75, eqn_text, 'Units', 'normalized', 'Interpreter', 'latex', 'FontSize', 18, 'HorizontalAlignment', 'center');
text(0.25, 0.65, r2_text, 'Units', 'normalized', 'Interpreter', 'latex', 'FontSize', 18, 'HorizontalAlignment', 'center');
